...
define( 'YOURLS_DB_USER', 'switas_prod' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'lD6gmPWW1YRPPe' );

/** The name of the database for YOURLS
 ** Use lower case letters [a-z], digits [0-9] and underscores [_] only */
define( 'YOURLS_DB_NAME', 'switas_prod' );
...
define( 'YOURLS_SITE', 'https://swit.as' );
...
define( 'YOURLS_COOKIEKEY', ')s$C-hCNG@QH[mxFZMGqUmX14SLQ&|1txO2j57qV' );
...
*/
$yourls_reserved_URL = [
	'porn', 'faggot', 'sex', 'nigger', 'fuck', 'cunt', 'dick', 'sik', 'got', 'amcik', 'yarak', 'yarrak', 'sikko',
];
